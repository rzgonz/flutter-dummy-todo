...
import 'data/local/entity/todo_entity.dart';

export 'package:objectbox/objectbox.dart'; // so that callers only have to import this file

final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 9004794810809100540),
      name: 'TodoEntity',
      lastPropertyId: const IdUid(3, 206238570597859319),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 8421836980854418209),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 5946385233430808792),
            name: 'name',
            type: 9,
            flags: 2080,
            indexId: const IdUid(1, 2449810664484421459)),
        ModelProperty(
            id: const IdUid(3, 206238570597859319),
            name: 'isDone',
            type: 1,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 9004794810809100540),
      lastIndexId: const IdUid(1, 2449810664484421459),
